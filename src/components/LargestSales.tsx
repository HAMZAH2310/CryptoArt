...
import { largestSalesImages } from "./data/largestSaleImages";
...
export default function LargestSales() {
  ...
  return (
    <section id="largest_sales" className="py-24 text-black">
      <div className="mx-auto mb-12 grid max-w-7xl grid-cols-1 items-center gap-6 px-24 md:grid-cols-2">
        <h1 className="text-4xl font-medium">Largest Sales</h1>
      ...
      <Swiper
        ...
        slidesPerView={3}
        spaceBetween={40}
        className="largest-sales-swiper"
        breakpoints={{
          0: { slidesPerView: 1.2 },
